# 9th August 2023 - Phone (TIZEN & WEAROS) SHM MOD 1.1.4.002 and 1.2.1.009 & Watch SHM MOD 1.2.1.009
 * Patched and released SHM MOD version: 1.1.4.002, it may be the last working version for Androids with OS 7 and 8...
...
Finally, did some patches to fix bugs in SHM:
